          ...
          <div className={styles.contentContainer}>
            <div className={`${styles.heroTextContainer} slide-in`}>
              <h1 className={styles.heroTitle}>
                meaningful{" "}
                <span className={styles.questionHighlight}>&ldquo;</span>
                solutions
                <span className={styles.questionHighlight}>&rdquo;</span>{" "}
                aren&apos;t always easy to create.
              </h1>
              <p className={`${styles.heroSubtitle} fade-in`}>
                but with dedication and collaboration, they become possible.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className={`${styles.bioSection} fade-in`}>
          ...
          <div className={styles.bioContent}>
            ...
            <p className={`${styles.bioText} slide-in`}>
              ...
              with a strong passion for continuous learning and solving complex
              problems. Throughout my career, I have had the privilege of
              contributing to{" "}
              <span className={styles.highlight}>challenging projects</span>{" "}
              that fostered growth and collaboration with dedicated teams
              focused on delivering{" "}
              <span className={styles.highlight}>impactful solutions</span>. I
              prioritize active listening, adaptability, and teamwork to drive{" "}
              <span className={styles.highlight}>success</span> and create
              meaningful outcomes.
            </p>
            <p className={styles.bioHighlight}>
              I look forward to applying my skills and experiences to tackle new
              challenges and deliver exceptional results. Let’s work together to
        ...
        <section className={`${styles.additionalContentSection} fade-in`}>
          <div className={`${styles.additionalContent} slide-in`}>
            <h2 className={styles.additionalTitle}>
              what drives me<span className={styles.questionHighlight}>?</span>
            </h2>
            <p className={styles.additionalText}>
              What drives me is a strong passion for creating meaningful
              solutions through technology. I thrive on tackling complex
              challenges, learning from them, and transforming them into
              opportunities for growth. Working with innovative teams and
              bringing together diverse perspectives sparks my creativity,
              enabling me to develop software that truly makes a difference for
              users and elevates their experiences.
            </p>
          </div>
        </section>
      </main>
