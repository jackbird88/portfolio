...
const projects: Project[] = [
  {
    ...
    type: "CASE STUDY:",
    description:
      "A cutting-edge platform designed to predict quarterly revenue impacted by extreme weather events, enabling proactive financial planning and strategic decision-making.",
  ...
  },
  {
    ...
    type: "CASE STUDY:",
    description:
      "A tailored web app for real-time golf cart tracking, enhancing operational efficiency and team communication by monitoring cart movements between the course and pro shop.",
  ...
  },
  {
    ...
    type: "CASE STUDY:",
    description:
      "A powerful LSTM-based analysis tool designed to predict sentiment in movie reviews, enhancing insights for data-driven decision-making and understanding customer feedback.",
  ...
  },
  {
    ...
    type: "CASE STUDY:",
    description:
      "Innovative platformer game developed for the GMTK Game Jam 2022, where the protagonist’s abilities are determined by a die roll mechanic.",
      ...
      <main className={styles.main}>
        <div className={styles.intro}>
          ...
          <p className={styles.subtitle}>
            A showcase of my most impactful work. Each project represents a
